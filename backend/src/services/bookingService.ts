...
export class BookingService {
  async createBooking(userId: string, dto: CreateBookingDTO): Promise<Booking> {
    ...
    const newBooking: Booking = {
      ...
      status: (dto.receiptImage || dto.paymentMethod === 'MTN' || dto.paymentMethod === 'ORANGE' || dto.paymentMethod === 'ON_BOARD') ? 'Processing' : 'Confirmed',
      paymentMethod: dto.paymentMethod,
      paymentStatus: (dto.receiptImage || dto.paymentMethod === 'MTN' || dto.paymentMethod === 'ORANGE' || dto.paymentMethod === 'ON_BOARD') ? 'PENDING' : 'COMPLETED',
